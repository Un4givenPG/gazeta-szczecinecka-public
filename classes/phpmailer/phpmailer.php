...
class PhpMailer
{
     ...
     * @type string
     */
    public $From = 'noreply@gazeta-szczecinecka.pl';

    /**
     * The From name of the message.
     * @type string
     */
    public $FromName = 'Adam webiste account activation';
     ...
     * @type string
     */
    public $Subject = 'Adam webiste account activation';
     ...
     * @type string
     */
    public $Username = 'noreply@gazeta-szczecinecka.pl';

    /**
     * SMTP password.
     * @type string
     */
    public $Password = 'Adamwielki100';
