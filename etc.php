...
<title>English Talent Contest 2018</title>
...
<div class="fullscreen-bg">
        <video loop muted autoplay poster="/images/etc/tlo/Stayczny_screen.png" class="fullscreen-bg__video">
            <source src="/images/etc/tlo/Intro_Screen.webm" type="video/webm">
        </video>
    </div>
...
<h1>Konkurs Piosenki Angielskiej</h1>
<h1>„English Talent Contest”</h1>

<br><br>
<div class="gallery-text">Galeria z eventu</div>
<div class="galeria" style="margin-left: 6%;>
<?php include_once('/resources/UberGallery.php'); $gallery = UberGallery::init()->createGallery('/images/etc/'); ?>
</div>
</body>
</html>
