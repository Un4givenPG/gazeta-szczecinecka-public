  ...
  <defs>
	...
	<a xlink:href="/projekty">
      <path fill="#90A4AE" d="M22.9,20.1h-1.5l-0.5-0.5c1.8-2.1,2.9-4.8,2.9-7.7C23.8,5.3,18.5,0,11.9,0S0,5.3,0,11.9s5.3,11.9,11.9,11.9
	    ...
	    S16.4,20.1,11.9,20.1z"/></a>
    </g>

    <g id="map" viewBox="-50 -50 100 100" width= "20px" height="20px">
      <path fill="#90A4AE" d="M20.629 5h-9.257a1.6 1.6 0 0 0-1.601 1.603V25.4a1.6 1.6 0 0 0 1.601 1.601h9.257c.883 0 1.6-.718 1.6-1.601V6.603c0-.885-.717-1.603-1.6-1.603zm-6.247 1.023h3.302v.768h-3.302v-.768zm1.619 19.395a1.024 1.024 0 0 1-1.023-1.021 1.023 1.023 0 0 1 2.044 0c-.001.494-.46 1.021-1.021 1.021zm5.028-3.501H10.971V7.704h10.058v14.213z"/>
    </g>
...
<nav class="nav__cont">
  <ul class="nav">
    ...
    <li class="nav__items ">
     ...
     <a href="">Kontakt<br>[Placeholder]</a>
    </li>        
  </ul>
</nav>
...
<h1>„Transformacja”</h1>
<iframe width="956" height="538" src="https://www.youtube.com/embed/2Gp8dYw-EhE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<br><br>
<h1>Fotosy z filmu</h1>
<div class="galeria" style="margin-left: 6%;>
<?php include_once('/resources/UberGallery.php'); $gallery = UberGallery::init()->createGallery('/images/transformacja'); ?>
</div>
